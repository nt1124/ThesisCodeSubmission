...
\begin{document}
	...
	\chapter{Technical Background}
		...
		\section{Oblivious Transfer} \label{sec:OT_Intro}
			...
			The security of Oblivious Transfers is defined in a similar way to that of SMC, the focus is on Semi-honest(passive) and Malicious(active) adversaries.\\
