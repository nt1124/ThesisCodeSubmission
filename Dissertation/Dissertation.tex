...
% 
	...
	\chapter{Experiments} \label{sec:Results}
		...
		\section{Expectations}
			...
			\subsection{AES encryption}
				...
				%We considered experimenting with the alternative circuit provided by \cite{NigelCircuits} which takes in an expanded key schedule trading off reduced circuit size for increased number of inputs. However, while the reduction in circuit size would reduce building, checking and evaluation time this would be more than nullified by the increase in the number of inputs (and hence input generation costs) and the increase in the number of OTs involved.
	...
	\begin{thebibliography}{99}
		...
		\bibitem{Lindell_SMC_Youtube_Talks}
			Y. Lindell,
